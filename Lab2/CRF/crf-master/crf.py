...
crf.train('D:\PJ\IntelliLabs\Lab2\dataset1\train.utf8', 'data/chunking_small/model_5.json')
crf.load('data/chunking_small/model_5.json')
#crf.test('data/chunking_small/small_test.data')
